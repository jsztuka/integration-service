...
var _ = Describe("Gitops functions for managing ApplicationSnapshots", Ordered, func() {
	...
	BeforeEach(func() {
		...
		copiedEnvWithEnvVars = gitops.NewCopyOfExistingEnvironment(envWithEnvVars, namespace, hasIntTestSc, hasSnapshot)
		...
		copiedEnvWithEnvVarsITS = gitops.NewCopyOfExistingEnvironment(envWithEnvVars, namespace, hasIntTestScWithNoEnv, hasSnapshot)
		...
		copiedEnvWithEnvVarsDiff = gitops.NewCopyOfExistingEnvironment(envWithEnvVars, namespace, hasIntTestScDiff, hasSnapshot)
