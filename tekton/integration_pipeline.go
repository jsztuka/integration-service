...
func (r *IntegrationPipelineRun) WithIntegrationLabels(scenarioName string) *IntegrationPipelineRun {
	if r.ObjectMeta.Labels == nil {
		r.ObjectMeta.Labels = map[string]string{}
	}
	r.ObjectMeta.Labels[PipelinesTypeLabel] = pipelineTypeTest
	r.ObjectMeta.Labels[ScenarioNameLabel] = scenarioName

	return r
}

// WithApplicationAndComponent adds the name of both application and component as lables to the Integration PipelineRun.
func (r *IntegrationPipelineRun) WithApplicationAndComponent(application, component string) *IntegrationPipelineRun {
	if r.ObjectMeta.Labels == nil {
		r.ObjectMeta.Labels = map[string]string{}
	}
	r.ObjectMeta.Labels[ApplicationNameLabel] = application
	r.ObjectMeta.Labels[ComponentNameLabel] = component
